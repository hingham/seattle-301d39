...
//   var name = value1;
// }
//Could not create new instance with constructor function
...
// An object literal that holds all the key and value pairs that define Joe.
// 2. What is "this" when joe.scopeArrow() is invoked?
// The window object literal that the browser creates for all tabs
// 3. Explain why "this" is different when an arrow function is used.
// The arrow functions have a different scope. When arrow functions are used, the scope of the function bubbles up to the next nearest scope or function. Because the arrow functions don't bind a this, the this bubbles up to the whole window object. 
