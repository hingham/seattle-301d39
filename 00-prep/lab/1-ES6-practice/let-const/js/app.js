...
function displayPics(){
  ...
  //the 'const' is scoped to a code block and can not be called outside of that code block
  console.log(viewed);
...
//const cannot be reassigned. const i is already assigned at the beginning of the code
